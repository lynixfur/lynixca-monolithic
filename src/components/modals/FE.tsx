    ...
    if(nfc_tag === "cute" || nfc_tag === "cute.paw_left" || nfc_tag === "cute.paw_right" || nfc_tag === "cute_qr") {
        return (
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-neutral-800">
                ...
                <button data-modal-hide="default-modal" type="button" className="text-white bg-neutral-600 hover:bg-neutral-700 transition-colors focus:ring-4 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center"><i className="fa-brands fa-telegram"></i> Telegram</button>
                <button data-modal-hide="default-modal" type="button" className="text-white bg-cyan-700 hover:bg-cyan-800 transition-colors focus:ring-4 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center"><i className="fa-solid fa-paw"></i> Awooo!</button>
                </div>
            </div>
            </div>
        </div>       
