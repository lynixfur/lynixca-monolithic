            ...
            <main className="">
                <div className="mb-16 flex flex-col items-start">
                    ...
                    <div className="bg-neutral-800 p-5 rounded-md mt-5 flex flex-col justify-center items-center">
                            ...
                            <p className="font-bold text-cyan-600">Lynix</p>
                        </div>
                        
                        <div className="bg-neutral-800 p-5 rounded-md mt-5 flex flex-col justify-center items-center">
                            <img src="/fursona/gallery/pfp.png" alt="lynix" className="rounded mt-5 max-w-[150px] mb-2" />
                            <p className="mt-2 text-sm">Lynix&apos;s pfp</p>
                            <p className="font-bold text-cyan-600">Mulliganos</p>
                        </div>

                        <div className="bg-neutral-800 p-5 rounded-md mt-5 flex flex-col justify-center items-center">
                            <img src="/fursona/gallery/lynix_peeking.png" alt="lynix" className="rounded mt-5 max-w-[150px] mb-2" />
                            <p className="mt-2 text-sm">Lynix peeking</p>
                            <p className="font-bold text-cyan-600">KookiesCrafts</p>
                        </div>

                        <div className="bg-neutral-800 p-5 rounded-md mt-5 flex flex-col justify-center items-center">
                            <img src="/fursona/gallery/cute_lynix.png" alt="lynix" className="rounded mt-5 max-w-[150px] mb-2" />
                            <p className="mt-2 text-sm">Lynix being cute</p>
                            <p className="font-bold text-cyan-600">KookiesCrafts</p>
                        </div>
