    ...
    <div className="relative inline-block text-left">
      <div>
        <button
          ...
          className="font-bold text-xl text-neutral-900 flex items-center"
        >
          About
          <svg
            className={`-mr-1 ml-1 h-7 w-7 transition-transform duration-300 ${isOpen ? 'rotate-180' : 'rotate-0'
              }`}
