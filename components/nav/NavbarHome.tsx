...
export default function Navbar() {
  ...
  if (pathname != "/login") {
    return (
      <>
        <header className="py-5 px-7 md:px-24 bg-[#01336c] border-[#51a9b0] bg-[#0a0a0a]">
          <nav className="flex items-center justify-between">
            <div className="flex space-x-5 items-center">
              <div className="py-1.5 px-5 bg-red-700 rounded-full">
                <i className="fa-solid fa-triangle-exclamation mr-2"></i> Howl Network Service Downtime
            </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8 my-3">
              ...
              <a href="/events" className="font-bold text-xl transition-colors hover:text-[#aa72d5] flex items-center text-neutral-100">Conventions
                {/*<i className="fa fa-circle text-xs ml-2 text-green-600 hidden" aria-hidden="true"></i>*/}
              </a>
              <a href="/fursona" className="font-bold text-xl transition-colors hover:text-[#aa72d5] text-white">Furtrack</a>
              <a href="/socials" className="font-bold text-xl transition-colors hover:text-[#aa72d5] text-white">About</a>
              {/* Profile Picture */}
              {/* New Account Feature */}
